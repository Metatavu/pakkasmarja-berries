...
VALUES
  ('b1590990-4bbb-11e9-8646-d663bd873d93', 1005, 'Product 1', 100, 10, 'KG', 'SAP1', true, NOW(), NOW()),
  ('b1590dd2-4bbb-11e9-8646-d663bd873d93', 2005, 'Product 2', 120, 20, 'KG', 'SAP2', false, NOW(), NOW());
...
INSERT INTO 
  Deliveries (id, productId, userId, time, status, amount, unitPriceWithBonus, unitPrice, qualityId, deliveryPlaceId, createdAt, updatedAt, inSap)
VALUES
  ('bad02318-1a44-11e8-87a4-c7808d590a08', 'b1590990-4bbb-11e9-8646-d663bd873d93', '6f1cd486-107e-404c-a73f-50cc1fdabdd6', NOW(), 'PLANNED', 5, 10, 10, NULL, 1010, NOW(), NOW(), false)