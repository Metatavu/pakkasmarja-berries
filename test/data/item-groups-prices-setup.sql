...
VALUES 
  ...
  ('30685c88-3103-11e8-91df-87fa68b14005', 'Group 1', '€ / l', '8.00', 2018, (SELECT id FROM ItemGroups WHERE externalId = '89723408-0f51-11e8-baa0-dfe7c7eae257'), NOW(), NOW()),
  ...
  ('7f1761a8-3103-11e8-b2e0-1b2fa8a35f72', 'Group 2', '$ / kg', '1.00', 2018, (SELECT id FROM ItemGroups WHERE externalId = '98be1d32-0f51-11e8-bb59-3b8b6bbe9a20'), NOW(), NOW());